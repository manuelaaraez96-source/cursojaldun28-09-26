...
const CONFIG = {
  ...
  seo: {
    ...
    tituloCompartir: "Formación superior · Principales patologías capilares que se encuentran en los centros de imagen personal.",
  ...
  hero: {
    ...
    subtitulo: "Formación Superior en Tricología aplicada a centros de imagen personal. Aprende a detectar las principales patologías del cuero cabelludo y a colaborar en su tratamiento.",
  ...
  footer: {
    ...
    enlaces: [
      { texto: "Política de privacidad",  url: "https://jaldun.com/politica-de-privacidad/" },
      { texto: "Términos y condiciones",  url: "https://jaldun.com/terminos-y-condiciones/" },
      { texto: "Política de Datos",       url: "https://jaldun.com/politica-de-datos/" },
    ],
